...
public class DayTwoFragment extends Fragment {
    ...
    void setUpRecycler(){
        ...
        adapter = new ScheduleItemsAdapter(eventsList, getActivity(), 14);
        ...
        if (eventsList.size() == 0) {
            ...
            try {
                ...
                jsonObject = new jsonLoader(getActivity(), "EventsDataSchedule.json").loadJSONFromAsset().getJSONObject("DAY2");
