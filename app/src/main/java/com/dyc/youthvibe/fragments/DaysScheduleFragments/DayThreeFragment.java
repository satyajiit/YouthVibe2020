...
public class DayThreeFragment extends Fragment {
    ...
    void setUpRecycler(){
        ...
        adapter = new ScheduleItemsAdapter(eventsList, getActivity().getApplicationContext(), 15);
        ...
        if (eventsList.size() == 0) {
            ...
            try {
                ...
                jsonObject = new jsonLoader(getActivity(), "EventsDataSchedule.json").loadJSONFromAsset().getJSONObject("DAY3");
