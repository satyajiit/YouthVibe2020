...
public class DayFourFragment extends Fragment {
    ...
    void setUpRecycler(){
        ...
        adapter = new ScheduleItemsAdapter(eventsList, getActivity(), 16);
        ...
        if (eventsList.size() == 0) {
            ...
            try {
                ...
                jsonObject = new jsonLoader(getActivity(), "EventsDataSchedule.json").loadJSONFromAsset().getJSONObject("DAY4");
